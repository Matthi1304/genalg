...
class CalibrationApp(ClockBase):
    ...
    def __init__(self, config_file="beamer.json"):
        ...
        self.accept("alt-arrow_left", self.rotate_number, [-0.01])
        self.accept("alt-arrow_left-repeat", self.rotate_number, [-0.01])
        self.accept("alt-arrow_right", self.rotate_number, [0.01])
        self.accept("alt-arrow_right-repeat", self.rotate_number, [0.01])
        ...
        self.add_help_text("Use ctrl + arrow left/right to rotate digit horizontaly")
        self.add_help_text("Use alt + arrow  left/right to rotate digit vertically)")
