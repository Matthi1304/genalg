...
class MyApp(ShowBase):
    ...
    def setup_lighting(self):
        ...
        self.point_light_np = self.render.attachNewNode(point_light)
        self.point_light_np.setPos(10, -10, 10)
    ...
    def setup_scene(self):
        ...
        self.cube.setColor(0.3, 0.7, 1.0, 1.0)
        self.cube.reparentTo(self.render)

        # Kleinere Würfel drumherum
        colors = [
            (1.0, 0.3, 0.3, 1.0),  # Rot
            (0.3, 1.0, 0.3, 1.0),  # Grün
            (1.0, 1.0, 0.3, 1.0),  # Gelb
